...
class BaseModel(nn.Module):
    ...
    def load_state_dict(
        ...
        from ofasys.utils.checkpoint_utils import prune_state_dict
...
class FairseqEncoderDecoderModel(BaseModel):
...
class FairseqMultiModel(BaseModel):
    ...
    def __init__(self, encoders, decoders):
        ...
        for key in self.keys:
            check_type(encoders[key], BaseEncoder)
            check_type(decoders[key], BaseDecoder)
...
class FairseqLanguageModel(BaseModel):
...
class FairseqEncoderModel(BaseModel):
