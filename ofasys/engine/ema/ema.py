...
class EMA(object):
    ...
    def build_fp32_params(self, state_dict=None):
        ...
        # for non-float params (like registered symbols),
        # they are copied into this dict and covered in each update
    ...
    def _step_internal(self, new_model, updates=None):
        ...
        for key, param in new_model.state_dict().items():
            ...
            # for non-float params (like registered symbols),
            # they are covered in each update
    ...
    def step(self, new_model, updates=None):
        ...
        """
        self._set_decay(0 if updates is not None and updates < self.config.ema_start_update else self.config.ema_decay)
