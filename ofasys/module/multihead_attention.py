...
from . import Dropout
from .fused_kernels import _is_fused_kernel_available
...
class MultiheadAttention(nn.Module):
    ...
    def __init__(
        ...
        self.use_fused = use_fused and _is_fused_kernel_available
        if self.use_fused:
            from ofasys.module.fused_kernels import FusedScaleMaskSoftmax
    ...
    def forward(
        ...
        if self.use_fused:
            ...
            attn_weights = self.fused_softmax(attn_weights, None)
