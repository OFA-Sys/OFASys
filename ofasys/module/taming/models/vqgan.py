...
from ofasys.module.taming.modules.diffusionmodules.model import Decoder, Encoder
from ofasys.module.taming.modules.vqvae.quantize import GumbelQuantize
from ofasys.module.taming.modules.vqvae.quantize import (
    VectorQuantizer2 as VectorQuantizer,
)
from ofasys.module.taming.util import instantiate_from_config


# VQModel of taming is a pytorch_lighning.LightningModule object.
# But OFA-Sys do not need the full functions of LightningModule,
# so here we change the inheritance to torch.nn.Module.
