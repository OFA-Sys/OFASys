...
from ofasys.configure.configs import DistributedTrainingConfig, TrainerConfig
...
def distributed_init(cfg: TrainerConfig):
...
def distributed_main(i, main, cfg: TrainerConfig, kwargs):
...
def call_main(cfg: TrainerConfig, main, **kwargs):
    if cfg.common.profile:
        with torch.cuda.profiler.profile():
            with torch.autograd.profiler.emit_nvtx():
                _call_main(cfg, main, **kwargs)
    else:
        _call_main(cfg, main, **kwargs)


def _call_main(cfg: TrainerConfig, main, **kwargs):
